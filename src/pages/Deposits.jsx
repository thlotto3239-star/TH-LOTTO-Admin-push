            ...
            <table className="w-full text-sm">
              <thead className="bg-surface-container text-left">
                <tr>
                  ...
                  <th className="px-4 py-3 text-xs font-semibold text-on-surface-variant uppercase tracking-wider whitespace-nowrap">โปร</th>
                  ...
                  <th className="px-4 py-3 text-xs font-semibold text-on-surface-variant uppercase tracking-wider whitespace-nowrap text-center">สลิป</th>
